...
const AllTopics = () => {
  return (
    <div className={` min-h-screen p-6 `}>
      ...
      >
        <Link to="htmlcss" smooth={true} duration={1}>
          <StatItem title={"HTML & CSS"} topicColor={techColors.htmlCss} numberOfQuestions={30} />
        </Link>

        <Link to="javascript" smooth={true} duration={1}>
          <StatItem title={"Javascript"} topicColor={techColors.javascript} />
        </Link>

        <Link to="react" smooth={true} duration={1}>
          <StatItem title={"React"} topicColor={techColors.react} />
        </Link>


        <Link to="mongodb" smooth={true} duration={1}>
          <StatItem title={"MongoDB"} topicColor={techColors.mongodb} />
        </Link>
        <Link to="nodejs" smooth={true} duration={1}>
          <StatItem title={"NodeJS"} topicColor={techColors.nodejs} />
        </Link>

        <Link to="express" smooth={true} duration={1}>
          <StatItem title={"Express"} topicColor={techColors.express} />
        </Link>
      </div>
